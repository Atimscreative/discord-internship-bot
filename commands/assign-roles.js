...
//   .setName("assign-role")
//   .setDescription("Assign yourself to a track/stack.")
...
//   try {
//     // Find or create role
//     let role = interaction.guild.roles.cache.find((r) => r.name === stack);
//     if (!role) {
...
//     // Channel access: Make sure you’ve created locked channels named after stacks
